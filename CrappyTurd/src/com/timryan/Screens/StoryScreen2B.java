...
public class StoryScreen2B implements Screen {
	...
	public StoryScreen2B(CTGame game, Sprite sprite) {
		this.game = game;
		this.sprite = sprite;
	}
	...
	private void setupTween() {
		...
		TweenCallback cb = new TweenCallback() {
			...
			public void onEvent(int type, BaseTween<?> source) {
				game.setScreen(new StoryScreen2C(game, new Sprite (AssetLoader.storyScreen2C)));
			}
		};
