...
public class StoryScreen4A implements Screen {
	...
	public StoryScreen4A(CTGame game, Sprite sprite) {
		this.game = game;
		this.sprite = sprite;
	}
	...
	private void setupTween() {
		...
		TweenCallback cb = new TweenCallback() {
			...
			public void onEvent(int type, BaseTween<?> source) {
				game.setScreen(new StoryScreen4B(game, new Sprite (AssetLoader.storyScreen4B)));
			}
		};
