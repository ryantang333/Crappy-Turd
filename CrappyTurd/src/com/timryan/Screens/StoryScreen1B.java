...
public class StoryScreen1B implements Screen {
	...
	public StoryScreen1B(CTGame game, Sprite sprite) {
		this.game = game;
		this.sprite = sprite;
	}
	...
	private void setupTween() {
		...
		TweenCallback cb = new TweenCallback() {
			...
			public void onEvent(int type, BaseTween<?> source) {
				game.setScreen(new StoryScreen1C(game, new Sprite(AssetLoader.storyScreen1C)));
			}
		};
