...
public class StoryScreen4C implements Screen {
	...
	public StoryScreen4C(CTGame game, Sprite sprite) {
		this.game = game;
		this.sprite = sprite;
	}
	...
	private void setupTween() {
		...
		TweenCallback cb = new TweenCallback() {
			...
			public void onEvent(int type, BaseTween<?> source) {
				game.setScreen(new StoryScreen4D(game, new Sprite (AssetLoader.storyScreen4D)));
			}
		};
