...
public class StoryScreen2A implements Screen {
	...
	public StoryScreen2A(CTGame game, Sprite sprite) {
		this.game = game;
		this.sprite = sprite;
	}
	...
	private void setupTween() {
		...
		TweenCallback cb = new TweenCallback() {
			...
			public void onEvent(int type, BaseTween<?> source) {
				game.setScreen(new StoryScreen2B(game, new Sprite (AssetLoader.storyScreen2B)));
			}
		};
