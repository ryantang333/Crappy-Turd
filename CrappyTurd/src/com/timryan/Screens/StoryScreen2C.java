...
public class StoryScreen2C implements Screen {
	...
	public StoryScreen2C(CTGame game, Sprite sprite) {
		this.game = game;
		this.sprite = sprite;
	}
	...
	private void setupTween() {
		...
		TweenCallback cb = new TweenCallback() {
			...
			public void onEvent(int type, BaseTween<?> source) {
				game.setScreen(new StoryScreen2D(game, new Sprite (AssetLoader.storyScreen2D)));
			}
		};
