...
public class StoryScreen3A implements Screen {
	...
	public StoryScreen3A(CTGame game, Sprite sprite) {
		this.game = game;
		this.sprite = sprite;
	}
	...
	private void setupTween() {
		...
		TweenCallback cb = new TweenCallback() {
			...
			public void onEvent(int type, BaseTween<?> source) {
				game.setScreen(new StoryScreen3B(game, new Sprite (AssetLoader.storyScreen3B)));
			}
		};
